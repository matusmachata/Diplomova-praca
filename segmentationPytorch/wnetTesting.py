...
model_path = "/kaggle/input/wnet_single_channels/pytorch/default/1/wnet_g_channel.pt"
...
for i, idx in enumerate(indices):
    if i == 0:
        img, true_mask = test_dataset[142]
    elif i == 1:
        img, true_mask = test_dataset[5]
    else:
